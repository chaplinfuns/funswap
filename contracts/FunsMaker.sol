...
contract FunsMaker {
    ...
    constructor(IUniswapV2Factory _factory, address _bar, address _funs, address _weth, address _uni) public {
        factory = _factory;
        funs = _funs;
        bar = _bar;
        weth = _weth;
    ...
    function convertUni() public {
        require(msg.sender == tx.origin, "do not convert from contract");
        uint256 wethAmount = _toWETH(uni);
        _toFUNS(wethAmount);
    }
    ...
    function _toFUNS(uint256 amountIn) internal {
